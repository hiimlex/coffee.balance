...
`,_=({recipe:e,data:t})=>{const i=e.formula(t.grounds,t.ratio),o=v(),r=(c,l)=>{const{label:a,isTimer:b}=e.stepsObject[c];let u=`${l+1}. ${a}`;return Object.keys(i).forEach(f=>{a.includes(f)&&(u=u.replace(f,i[f]))}),{label:u,isTimer:b}},s=()=>{o("/")};return n.jsxs(N,{children:[n.jsxs(T,{onClick:s,children:[n.jsx(P,{size:14,className:"icon"})," back"]}),n.jsx($,{}),n.jsxs(V,{children:[n.jsxs(h,{children:[n.jsx(m,{children:e.name}),n.jsx(x,{children:"recipe"})]}),n.jsxs(h,{children:[n.jsxs(m,{children:[t.grounds,"g/~",Number(t.grounds*t.ratio).toFixed(0),"ml"]}),n.jsx(x,{children:"size"})]}),n.jsxs(h,{children:[n.jsxs(m,{children:[e.minutes,"m"]}),n.jsx(x,{children:"time"})]})]}),e.steps.map((c,l)=>{const a=r(c,l);return n.jsx(A,{isTimer:a.isTimer,children:a.label},l)})]})},I=()=>{const{data:e,recipe:t}=S(r=>r.recipeMaker),i=R(),o=v();return y.useEffect(()=>{const r=localStorage.getItem(O);if(!e&&!t&&!r)o("/");else{const s=JSON.parse(r||"{}");if(s&&Object.keys(s).length>0){const c=s.recipeName;if(c){const l=E.find(a=>a.name===c);l&&i(k({recipe:l,data:s.data}))}}}},[]),n.jsx(n.Fragment,{children:t&&e?n.jsx(_,{recipe:t,data:e}):n.jsx("div",{children:"ops something wrong happened"})})};export{I as default};
